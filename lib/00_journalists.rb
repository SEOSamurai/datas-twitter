...
puts mail.grep(/[0-9]/).count

puts mail.count { |x| x[//] }

puts mail.count { |x| x[/^@\p{Upper}/] }

puts mail.count { |x| x[/\p{Upper}/] }


puts mail.count { |x| x[/_/] }

puts mail.sort(&:casecmp)

puts mail.index("@epenser")

puts mail = mail.sort_by {|x| x.length}

>>>>>>> ab2e2c254bf638f8854601f444f13a120d44f440
